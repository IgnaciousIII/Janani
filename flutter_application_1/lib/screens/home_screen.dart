...
import '../l10n/app_localizations.dart';// Import generated localization
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final int rchId = motherData['rchId'] ?? 'Unknown';
    final String mothername = motherData['motherName'] ?? 'Unknown';
    return Scaffold(
      appBar: AppBar(
        title: Text(
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        'Hello $mothername', // 'Hello Sumathi'
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text('RCH Id: $rchId'), // 'Card Number- 2005678'
                      ],
                    ),
                  ),
                ],
              ...
              SizedBox(
                ...
                child: GridView.count(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, '/profile', arguments: motherData);
                      },
                      child: ButtonContainer(
